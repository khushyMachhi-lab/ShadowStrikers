...
<body>
    ...
    <section class="events-section">
        <div class="container">
            ...
            <div class="text-center mt-5 fade-in">
                 <p class="text-muted">Need to host your event or seminar with us? <a href="/users" class="text-decoration-none fw-bold" style="color: var(--primary-color);">Contact our team for gym rental availability.</a></p>
            </div>
    ...
    <footer>
        <div class="container text-center">
            <div class="row">
                <div class="col-md-12">
                    <p class="mb-0 fw-bold">&copy; 2025 ShadowStrike - Your Fight Club. All rights reserved.</p>
                    <div class="mt-3">
